from transformers import pipeline, MBartForConditionalGeneration, BartTokenizer, MBartTokenizer
import logging
import torch
import re
import string
...
def summarize_text(text, max_length=None, min_length=None):
    ...
    try:
        ...
        # Detect language and check for code-mixing
        ...
        try:
            ...
            for chunk in chunks:
                ...
                summary = bart_summarizer(
                    chunk_with_focus,
                    max_length=min(max_length, 512),  # Stay within BART limits
                    min_length=min(min_length, 100),
                    do_sample=False,
